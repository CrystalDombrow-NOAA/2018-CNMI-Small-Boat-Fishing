...
#DATA SUMMARIES
q30.data.sum <- data.summaries.function(cnmi.data.cleaned, 
                                        q.number = "Q30.boatowner")

q30.nozeros.data.sum <- data.summaries.function(cnmi.data.cleaned, 
...
#DATA SUMMARIES
q31.data.sum <- data.summaries.function(cnmi.data.cleaned, 
                                        q.number = "Q31.boatowner")

q31.nozeros.data.sum <- data.summaries.function(cnmi.data.cleaned, 
...
#DATA SUMMARIES
q32.data.sum <- data.summaries.function(cnmi.data.cleaned, q.number = "Q32")

q32.nozeros.data.sum <- data.summaries.function(cnmi.data.cleaned, 
...
#DATA SUMMARIES
q33.data.sum <- data.summaries.function(cnmi.data.cleaned, 
                                        q.number = "Q33.boatowner")

q33.nozeros.data.sum <- data.summaries.function(cnmi.data.cleaned, 
