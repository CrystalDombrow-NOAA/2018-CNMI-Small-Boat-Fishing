...
#DISTRIBUTION
q42.distr <- distribution.function(cnmi.data.cleaned, q.number = "Q42", 
                                   categories = 1:2)
...
#DATA SUMMARIES
q43.data.sum <- data.summaries.function(cnmi.data.cleaned, q.number = "Q43.mid")


#DISTRIBUTION
q43.distr <- distribution.function(cnmi.data.cleaned, q.number = "Q43", 
                                   categories = 1:6)
...
#DISTRIBUTION
q44.distr <- distribution.no.table.function(cnmi.data.cleaned, q.number = "Q44")
...
#DATA SUMMARIES
q45.data.sum <- data.summaries.function(cnmi.data.cleaned, q.number = "Q45")
...
#DATA SUMMARIES
q45.data.sum <- data.summaries.function(cnmi.data.cleaned, q.number = "Q46")
...
#DISTRIBUTION
q48.distr <- distribution.function(cnmi.data.cleaned, q.number = "Q48A", 
                                   categories = 1:5)
...
#DISTRIBUTION
q49.distr <- distribution.function(cnmi.data.cleaned, q.number = "Q49A.1", 
                                   categories = 1:16)
...
#DISTRIBUTION
q50.distr <- distribution.function(cnmi.data.cleaned, q.number = "Q50A", 
                                   categories = 1:7)
...
#DATA SUMMARIES
q51.data.sum <- data.summaries.function(cnmi.data.cleaned, q.number = "Q51")
...
#DISTRIBUTION
q52.distr <- distribution.function(cnmi.data.cleaned, q.number = "Q52", 
                                   categories = 1:7)
...
#DISTRIBUTION
q53.distr <- distribution.function(cnmi.data.cleaned, q.number = "Q53", 
                                   categories = 1:11)


#DATA SUMMARIES
q53.data.sum <- data.summaries.function(cnmi.data.cleaned, q.number = "Q53.mid")
