...
#FULL SAMPLE
q40.full.sample <- annual.expenditures.function(cnmi.data.cleaned, 
                                                breakdown = "Full.sample")

#island
 q40.island <- annual.expenditures.function(cnmi.data.cleaned, 
                                          breakdown = "Island")

#SELL FISH
q40.sell.fish <- annual.expenditures.function(cnmi.data.cleaned, 
                                              breakdown = "sell.fish.chr")

#HIGHLINER
q40.highliner <- annual.expenditures.function(cnmi.data.cleaned, 
                                              breakdown = "highliner")

#PRIMARY TARGET
q40.primary.target <- annual.expenditures.function(cnmi.data.cleaned, 
                                                   breakdown = "primary.target")

#BOAT OWNER
q40.boat.owner <- annual.expenditures.function(cnmi.data.cleaned, 
...
#[n] for tables
#--------------
q40.n.fortables <- cnmi.data.cleaned %>%
...
#DATA SUMMARIES
q41.data.sum <- data.summaries.function(cnmi.data.cleaned, q.number = "Q41")
