...
q24a.distr <- distribution.function(cnmi.data.cleaned, q.number = "Q24A", 
                                    categories = 1:2)
...
#DATA SUMMARIES
q24b.data.sum <- data.summaries.function(cnmi.data.cleaned, q.number = "Q24B")
...
#DISTRIBUTION
q24c.distr <- distribution.function(cnmi.data.cleaned, q.number = "Q24C", 
                                    categories = 1:2)
...
#DATA SUMMARIES
q26.data.sum <- data.summaries.function(cnmi.data.cleaned, 
...
#DATA SUMMARIES
q27.data.sum <- data.summaries.function(cnmi.data.cleaned, 
...
#DATA SUMMARIES
q28.data.sum <- data.summaries.function(cnmi.data.cleaned, 
                                        q.number = "Q28.mid.boatowner")

#DISTRIBUTION
q28.distr <- distribution.function(cnmi.data.cleaned, q.number = "Q28.boatowner", 
                                   categories = 1:6)
...
#DATA SUMMARIES
q29.data.sum <- data.summaries.function(cnmi.data.cleaned, 
